...
the beginning or end of the file. \r\n line endings will be counted correctly as
well, since there is only one \n per \r\n.
...
To use it in the status line, refer to wc.cc, wc.wc and wc.lc, which refer to
the char count, word count and line count respectively.
